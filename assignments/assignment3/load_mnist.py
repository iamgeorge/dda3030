...
if __name__ == "__main__":
        ...
        X_train,X_test,Y_train,Y_test  = load_mnist(path = path, flatten = False,binary_data = True)
        assert X_train.shape == (60000, 28, 28)
        assert X_test.shape == (10000, 28, 28)
        assert Y_train.shape == (60000,)
        assert Y_test.shape == (10000,)
        X_train,X_test,Y_train,Y_test  = load_mnist(path = path, flatten = True,binary_data = True) 
